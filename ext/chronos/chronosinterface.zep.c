...
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, startOfWeek);
...
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, endOfWeek);
...
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameDay);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameMonth);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameQuarter);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameYear);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameWeek);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameHour);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameMinute);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isSameSecond);
