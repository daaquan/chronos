...
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, isLongYear);
...
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, getWeekOfMonth);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, getMonthOfYear);
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, getTimestamp);
...
ZEPHIR_DOC_METHOD(Chronos_ChronosInterface, setMicrosecond);
